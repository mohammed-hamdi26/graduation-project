...
import { FaDisease, FaFemale, FaMale, FaPhoneAlt } from "react-icons/fa";
...
async function PatientInfo({ patient }) {
  ...
  return (
    <div className=" flex flex-col flex-1">
      ...
      <div className="flex-[0.5]  bg-gray-100 p-3 rounded-b-lg flex gap-4 justify-between items-center ">
        {" "}
        ...
        <div className="relative w-72  h-72">
          <Image
            src={
              user.cancer_photo
                ? ` ${process.env.API_URL}${user.cancer_photo}`
                : ""
            }
            fill
            alt=""
